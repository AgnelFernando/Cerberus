...
class UltraSonicSubTopic(str, Enum):
    """Topics for ultrasonic data"""
    ULTRASONIC_DATA = "robot/ultrasonic"
...
SubTopic = Union[BmsSubTopic, FirmwareSubTopic, UltraSonicSubTopic]
...
class Topics:
    ...
    def get_sub_topics() -> List[str]:  # Changed from list[str] to List[str]
        ...
        return ([topic.value for topic in BmsSubTopic] + 
                ...
                [topic.value for topic in UltraSonicSubTopic])
